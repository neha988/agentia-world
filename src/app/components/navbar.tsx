  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? "py-4 bg-agentia-dark/80 glass backdrop-blur-lg" : "py-6 bg-transparent"
      }`}
    >
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-48 origin-top-left glass-card rounded-lg p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                <Link href="/ai-agents" className="block px-4 py-2 text-sm rounded-md hover:bg-white/10 transition-colors">
                  AI Agents
                </Link>
                <Link href="/templates" className="block px-4 py-2 text-sm rounded-md hover:bg-white/10 transition-colors">
                  Templates
                </Link>
                <Link href="/new-arrivals" className="block px-4 py-2 text-sm rounded-md hover:bg-white/10 transition-colors">
                  New Arrivals
                </Link>
              </div>
            </div>
